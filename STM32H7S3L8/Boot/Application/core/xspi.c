...
void xspi_init( void )
{
    ...
    /* Включить тактирование SBS и настроить High Speed Low Voltage XSPI2 */
...
/**
 * Настроить максимальное значение частоты для XSPI.
 */
